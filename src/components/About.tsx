...
//   return (
//     <>
//       <div className='flex flex-col md:flex-row font-mono justify-around items-center text-textColor px-4 md:px-16 h-[auto] md:h-[90vh]'>
//         <div className='w-full md:w-3/5 flex flex-col items-center md:items-start text-center md:text-left mb-8 md:mb-0'>
//           <div className='text-2xl md:text-3xl text-primaryColor'>Hi, I am</div>
//           <div className='text-white text-[2.5rem] xs:text-[3rem] md:text-[4.25rem] font-extrabold'>Suraj Omar</div>

//           <div className='text-white text-2xl xs:text-3xl md:text-4xl flex'>
//             I'm a&nbsp;
...
//           <div className='text-textColor w-full md:w-[90%] text-lg xs:text-xl my-4 md:my-8 text-justify'>
//             {Info.bio}
//           </div>

//           <div className="flex flex-col sm:flex-row gap-2 w-full justify-center md:justify-start">
//             <Button onClick={open} className='!text-bgColor !w-full sm:!w-fit' size='lg' variant="filled" color='#64FFDA'>Check Resume</Button>
//             <Button component="a" href="SurajOmar_resume.pdf" download={"SurajOmar_resume"} className="focus-visible:!outline-none !text-primaryColor !w-full sm:!w-fit" size={'lg'} variant="outline" color="#64FFDA" rightSection={<IconDownload size={20} />}>Download</Button>
//           </div>
//         </div>

//         <div className='w-[60vw] xsm:w-[50vw] xs:w-[40vw] sm:w-[35vw] md:w-[30vw] h-[50vh] sm:h-[60vh] rounded-full flex justify-center items-center mb-8 md:mb-0'>
//           <img className='!shadow-[0_0_200px_0_#64FFDA] w-[60vw] xsm:w-[50vw] xs:w-[40vw] sm:w-[35vw] md:w-[30vw] h-[50vh] sm:h-[60vh] rounded-full' src="suraj.jpg" alt="Suraj Omar" />
//         </div>
//       </div>
            ...
            <div data-aos="zoom-out-up" data-aos-duration="800" className="mt-28 flex relative overflow-hidden justify-around items-center font-mono px-10 py-10 sm-mx:px-4 xs-mx:px-2 xs-mx:py-4 h-fit lg-mx:justify-between bs-mx:flex-wrap bs-mx:flex-col-reverse bs-mx:!overflow-visible bs-mx:gap-6 md-mx:px-6" id="About">
                ...
                <div className="h-fit flex justify-center items-center rounded-full bs:mr-10 w-fit">
                    <NeonGradientCard className="w-[325px] h-[325px] lg-mx:w-64 lg-mx:h-64 xsm-mx:w-56 xsm-mx:h-56 items-center justify-center text-center">
                        <img className="w-full  h-full rounded-full " src="suraj.jpg" alt="./profile.png" />
